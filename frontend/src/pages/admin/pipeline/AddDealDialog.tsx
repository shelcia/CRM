...
import { CustomTextField, CustomSelectField } from "@/components/custom/CustomInputs";
import { Input } from "@/components/ui/input";
import { Label } from "@/components/ui/label";
import { apiDeals } from "@/services/models/dealsModel";
import useUsers from "@/hooks/useUsers";
import { Deal, CURRENCIES, STAGE_ITEMS } from "./pipelineTypes";
        ...
        <form onSubmit={handleSubmit} className="space-y-4 pt-1">
          ...
          <div className="space-y-1">
            ...
            <Select
              ...
              onValueChange={(v) =>
                handleChange({ target: { name: "assignedTo", value: v === "__none__" ? "" : v } })
              }
            >
              <SelectTrigger>
                <SelectValue />
