...
const PrivacyPolicy = () => {
  return (
    <React.Fragment>
      ...
      >
        <CustomBox pt={5} px={5} sx={{ color: "white" }}>
          <CustomTypography variant="h1" color="light" textGradient>
            Privacy Policy
          </CustomTypography>
          <br />
          <CustomTypography variant="caption" color="secondary" textGradient>
          ...
          <ul>
            ...
            <li>
              <CustomTypography variant="body2" color="secondary" textGradient>
                ...
                in this Agreement) refers to Easy-CRM.
              </CustomTypography>
            </li>
            <li>
              <CustomTypography variant="body2" color="secondary" textGradient>
            ...
            <li>
              <CustomTypography variant="body2" color="secondary" textGradient>
                <strong>Website</strong> refers to Easy-CRM, accessible from{" "}
                <a
                  href="https://freee-crm.netlify.app/"
                  rel="external nofollow noopener noreferrer"
                  target="_blank"
                >
                  https://freee-crm.netlify.app/
                </a>
              </CustomTypography>
            </li>
            <li>
          ...
          <ul>
            <li>
              <CustomTypography variant="body2" color="secondary" textGradient>
                ...
                <a
                  href="freee-crm.netlify.app/"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  freee-crm.netlify.app/
                </a>
              </CustomTypography>
            </li>
          </ul>
